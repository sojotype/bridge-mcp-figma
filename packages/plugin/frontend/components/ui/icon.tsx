...
const Checkmark = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      d="M12.128 4.512a1 1 0 1 1 1.744.976l-3.579 6.392c-1.226 2.189-4.437 1.996-5.392-.324l-.826-2.01a1 1 0 0 1 1.85-.76l.826 2.009a1 1 0 0 0 1.798.107l3.579-6.39Z"
      fill="currentColor"
    />
  </svg>
);
